...
def first_alignment(max_holes, min_dist):
    ...
    while (GPIO.input(proxy_videocamera) == True):
        ...
        if ret == True:
            ...
            coordinates, _, frame_color = detect_hole(thresholded_img)
            first_point, second_point, _, _ = middleR_perform(frame_color, coordinates, sup_lim, inf_lim)
            ...
            if (cycle_iterator == 1): # setta il range di controllo solo al primo richiamo della funzione (quindi al primo frame).
                ...
                Y_max = center_needles - 5   
                Y_min = center_needles + 5
