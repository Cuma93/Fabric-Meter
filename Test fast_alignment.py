    ...
    while (feeding_times < 6):
        ...
        if ret == True:
            ...
            if (cycle_iterator == 1): # setta il range di controllo solo al primo richiamo della funzione (quindi al primo frame).
                ...
                first_distance_y = abs(center_needles - first_point[1]) #...........................Calcola la distanza y tra il primo punto più a sx e il centro delle bobine.
                second_distance_y = abs(center_needles - second_point[1]) #.........................Calcola la distanza y tra il secondo punto più a sx e il centro delle bobine.
                
                if (first_distance_y <= second_distance_y):
                    y_winner = first_point[1]
                    first_distance_x = (first_point[0] - 640 / (max_holes * 2))    # distanza x tra centro del foro e la posizione desiderata di partenza (640/numero_fori_riga  /2)
                    
                    if (first_distance_x > 0):
                        print(first_distance_x)
                        first_feeding = pos[3] - round(first_distance_x * 3.19444444444)
                        stepC(first_feeding, 3) 
                
                else:
                    y_winner = second_point[1]
                    first_distance_x = second_point[0] - 640 / (max_holes * 2)
